...
function PMKError(msg) {
  ...
  this.name = 'Postmark Error',
  this.message = typeof msg === 'string' ? msg : 'An error occurred';
}
PMKError.prototype.__proto__ = Error.prototype;

PMKError.prototype.toString = function() {
